...
public class EnderSeeCommand implements CommandExecutor {
    ...
    public boolean onCommand(CommandSender commandSender, Command command, String s, String[] args) {
        ...
        if (!commandSender.hasPermission("ss.endersee")) {
        ...
        if (args.length == 0) {
            ...
            if (player == null) {
                ...
                commandSender.sendMessage(MessageUtil.message(SimplyStaff.INSTANCE.getConfig().getString("COMMANDS.Basic.endersee"), player));
